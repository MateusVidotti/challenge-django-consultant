...
class LoanExtraField(models.Model):
    ...
    field_attrs = models.JSONField(
        null=True,
        blank=True,
        help_text='Json with form fields attributes '
...
class LoanForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in extra_fields:
            ...
            self.fields[field.field_name] = import_string(
                f'django.forms.{field.get_field_type_display()}Field'
            )(**field.field_attrs)
